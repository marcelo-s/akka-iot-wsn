    ...
    public Receive createReceive() {
        return receiveBuilder()
                ...
                .match(
                        ...
                        mRemoved -> log.info("******** MEMBER LEFT: {} ********", mRemoved.member()))
                .match(
                        ClusterEvent.MemberExited.class,
                        mRemoved -> log.info("******** MEMBER EXITED: {} ********", mRemoved.member()))
                .match(
                ...
                .match(
                        ...
                        message -> {
                            String result = String.format("************UNKNOWN EVENT************** >>>>>>>> %s", message.toString());
                            log.info(result);
                        })
                .build();
    }
